...
import { ImageCarousel } from "@/components/Video";
...
const heroData = {
  ...
  heading: "Lleva a tu Equipo al Siguiente Nivel...",
  text: "Cursos especializados para empresas que buscan mejorar sus procesos, liderazgo y productividad. Aprende con expertos y transforma tu equipo.",
  cta: {
    id: 7,
    href: "https://github.com/PaulBratslavsky/next-strapi-template-starter-code",
    text: "Empieza con nostros",
    external: true,
  },
  image: {
    id: 2,
